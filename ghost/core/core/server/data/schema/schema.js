...
module.exports = {
    ...
    suar_post_lock: {
        ...
        post_id: { type: 'string', max_length: 24, nullable: false, references: 'posts.id', cascadeDelete: true },
        user_id: { type: 'string', max_length: 24, nullable: true, references: 'users.id', setNullDelete: true },
        locked_at: { type: 'timestamp', nullable: false, defaultTo: 'now()' }
    },
};
